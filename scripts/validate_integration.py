...
with app.test_client() as c:
    ...
    checks.append(('Dashboard has NO output.css', 'dist/output.css' not in dashboard_html))
    ...
    if rv.status_code == 200:
        ...
        checks.append(('Route /placement/drives (may need route)', rv.status_code < 500))
    ...
    if rv.status_code == 200:
        ...
        checks.append(('Route /placement/career (may need route)', rv.status_code < 500))
    ...
    if rv.status_code == 200:
        ...
        checks.append(('Route /placement/applications (may need route)', rv.status_code < 500))
